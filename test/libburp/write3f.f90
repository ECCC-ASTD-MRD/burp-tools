      ...
      program WRITE3
        ...
        path_out = 'file_write3f' ! fichier a creer par defaut
        ...
        copy_of_blk_out = .CLEAR.copy_of_blk_out
        Call BURP_Set_Rval(copy_of_blk_out,&
                NELE_IND= 1,NVAL_IND =1,NT_IND= 1,RVAL= 0.00009,IOSTAT=error)
        Call BURP_Set_Rval(copy_of_blk_out,&
                NELE_IND= 1,NVAL_IND =2,NT_IND= 1,RVAL= 0.0000097,IOSTAT=error)
